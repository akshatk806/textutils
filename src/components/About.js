...
export default function About() {
    ...
    return (
        <div className="container" style={myStyle}>
            ...
            <div className="my-2">
                {/* <button onClick={toggleStyle} type="button" className="btn btn-sm btn-secondary">{btnText}</button> */}
                <button onClick={toggleStyle} type="button" className={"btn btn-sm btn-"+btnColor}>{btnText}</button>
            </div>
        </div>
    )
}
